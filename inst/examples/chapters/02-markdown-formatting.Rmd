...
So to create a reference for this section I can use `\@ref(format)`. You can also create links. For example, the following code will create a link where the word "instructions" links to the "Getting started" section in Chapter \@ref(using-cosmodown):
