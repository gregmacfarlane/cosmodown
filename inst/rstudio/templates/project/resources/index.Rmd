...
# Welcome to the cosmodown thesis and dissertation template! To ensure you
# have all of the necessary software installed, please check the README here:
# https://github.com/wjakethompson/cosmodown
...
`r if (knitr::is_html_output()) cosmodown::inc("pre/00-abstract.Rmd")`

`r if (knitr::is_html_output()) "# Acknowledgements {-}"`

`r if (knitr::is_html_output()) cosmodown::inc("pre/00-acknowledge.Rmd")`
