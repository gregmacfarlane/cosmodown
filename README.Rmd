...
This package provides a template for writing theses and dissertations at the
...
The original LaTeX template and class document were written by Greg Macfarlane, and modified for use with pandoc and R markdown.
...
3. Select from templates, the University of Kansas Thesis template from the **cosmodown** package.
...
If you are not using RStudio, you can create a new R Markdown from the **cosmodown** template by using `rmarkdown::draft()`.

1. Open R in your preferred IDE.
2. Open the **cosmodown** template using `rmarkdown::draft()`. This will create a directory called `index/` (or whatever you name the R Markdown document) in your current working directory.
